...
export default function TabView<T extends Route>({
  ...
  tabBarPosition = 'top',
  headerComponent,
  isWrapScrolllView = false,
}: Props<T>) {
  let WrapContainer: any = React.Fragment;

  if (isWrapScrolllView) {
    WrapContainer = ScrollView;
  }
  ...
  if (isWrapScrolllView && headerComponent) {
    containerProps.stickyHeaderIndices = [1];
  }
